...
function CryptoDetails() {
  ...
  const stats = [
    ...
    { title: 'Listed At', value: `$ ${cryptoDetails?.listedAt && millify(cryptoDetails?.listedAt)}`, icon: <ThunderboltOutlined /> },
    ...
    <Col className="coin-detail-container">
      <Col className="coin-heading-container">
        <div className="details-heading">
          <img src={data?.data?.coin.iconUrl} alt="" style={{'width': '50px', 'height': '50px', 'marginRight': '15px'}} />
          <Title level={2} className="coin-name" style={{'margin': '0'}}>
      ...
      <Col className="stats-container">
        <Col className="coin-value-statistcs">
